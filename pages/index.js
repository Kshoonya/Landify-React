      ...
      <div className="home-container">
        ...
        <div className="home-feature1">
          ...
          <div className="home-container19">
            <h3 className="home-text32 Headline3">Features and Benefits</h3>
            <div className="home-container20">
              <div className="home-container21">
                <img
                  alt="image"
                  src="/playground_assets/_a44f30b0-445a-4963-8d0e-b5d74b59a155-600h.jpeg"
                ...
                <div className="home-container25">
                  <div className="home-container26">
                    <span className="home-text33">
                      At Kshoonya, we are committed to making sure our products
                      and services are easy to use, reliable, and secure.
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="home-feature2">
          <section className="home-container30">
            <h2 className="home-text37">
              <span className="home-text38">Possibilities are endless</span>
        ...
        <div className="home-footer">
          <footer className="home-container52">
            <img
              alt="image"
              src="/playground_assets/new_design_full%203-500w.png"
